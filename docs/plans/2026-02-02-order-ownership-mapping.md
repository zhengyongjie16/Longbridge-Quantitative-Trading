...
import { parseOrderOwnership, resolveOrderOwnership, getLatestTradedSymbol } from '../src/core/orderRecorder/orderOwnershipParser.js';
...
test('getLatestTradedSymbol uses mapping to pick latest fill', () => {
  const orders = [
    { stockName: 'HS#ALIBARC2301A', status: 2, updatedAt: new Date('2026-02-02T00:00:00Z'), symbol: 'AAA.HK' },
    { stockName: 'HS#ALIBARP2807F', status: 2, updatedAt: new Date('2026-02-02T01:00:00Z'), symbol: 'BBB.HK' },
  ];
