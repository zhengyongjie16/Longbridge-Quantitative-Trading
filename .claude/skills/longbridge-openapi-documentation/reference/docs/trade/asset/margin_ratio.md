...
| Rust | [longport::<SDKLinks module="trade" klass="TradeContext" method="margin_ratio" />::trade#_trade_context](https://longportapp.github.io/openapi/rust/longport/<SDKLinks module="trade" klass="TradeContext" method="margin_ratio" />/struct.trade.html#method._trade_context) |
| Go | [trade.margin_ratio](https://pkg.go.dev/github.com/longportapp/openapi-go/<SDKLinks module="trade" klass="TradeContext" method="margin_ratio" />#trade.margin_ratio) |
