...
| Rust | [longport::<SDKLinks module="trade" klass="TradeContext" method="submit_order" />::trade#_trade_context](https://longportapp.github.io/openapi/rust/longport/<SDKLinks module="trade" klass="TradeContext" method="submit_order" />/struct.trade.html#method._trade_context) |
| Go | [trade.submit_order](https://pkg.go.dev/github.com/longportapp/openapi-go/<SDKLinks module="trade" klass="TradeContext" method="submit_order" />#trade.submit_order) |
