...
| Rust | [longport::<SDKLinks module="trade" klass="TradeContext" method="replace_order" />::trade#_trade_context](https://longportapp.github.io/openapi/rust/longport/<SDKLinks module="trade" klass="TradeContext" method="replace_order" />/struct.trade.html#method._trade_context) |
| Go | [trade.replace_order](https://pkg.go.dev/github.com/longportapp/openapi-go/<SDKLinks module="trade" klass="TradeContext" method="replace_order" />#trade.replace_order) |
...
| limit_offset      | string | NO       | Limit offset amount `TSLPAMT` / `TSLPPCT` Order Required when`limit_depth_level` is set to 0   |
| trailing_amount   | string | NO       | Trailing amount `TSLPAMT` Order Required                                                       |
| trailing_percent  | string | NO       | Trailing percent `TSLPPCT` Order Required                                                      |
