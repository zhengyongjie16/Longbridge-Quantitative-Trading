...
| Rust | [longport::<SDKLinks module="trade" klass="TradeContext" method="estimate_max_purchase_quantity" />::trade#_trade_context](https://longportapp.github.io/openapi/rust/longport/<SDKLinks module="trade" klass="TradeContext" method="estimate_max_purchase_quantity" />/struct.trade.html#method._trade_context) |
| Go | [trade.estimate_max_purchase_quantity](https://pkg.go.dev/github.com/longportapp/openapi-go/<SDKLinks module="trade" klass="TradeContext" method="estimate_max_purchase_quantity" />#trade.estimate_max_purchase_quantity) |
