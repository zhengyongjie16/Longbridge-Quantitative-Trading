...
description: 编写简洁、易于维护且遵循严格规范的 TypeScript 代码。在编写、修改或重构 .ts 文件时使用。强制执行核心原则（必须遵守）。适用场景：创建新 TypeScript 文件、重构现有代码、代码审查、修复类型错误、检查代码规范、eslint 和 type-check。当用户提到"写代码"、"重构"、"修改"、"检查"、"创建文件"、"添加功能"时自动使用这个skill。
---
