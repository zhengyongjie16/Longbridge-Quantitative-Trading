 ...
 * 使用范围：tradeTaskQueue、buyProcessor、sellProcessor、timeDriverProgram 等，仅内部使用。
 */
 ...
 * 使用范围：timeDriverProgram、buyProcessor、sellProcessor、processMonitor、lifecycle 等，仅内部使用。
 */
 ...
 * 使用范围：tradeTaskQueue、buyProcessor、timeDriverProgram 等，仅内部使用。
 */
 ...
 * 数据来源：由信号流水线/延迟验证回调在入队时指定。
 * 使用范围：tradeTaskQueue、sellProcessor、timeDriverProgram 等，仅内部使用。
 */
