/**
 * @module tests/main/processMonitor/signalPipeline.business.test.ts
 * @description 测试模块，围绕 signalPipeline.business.test.ts 场景验证 tests/main/processMonitor 相关业务行为与边界条件。
 */
