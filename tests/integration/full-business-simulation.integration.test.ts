/**
 * @module tests/integration/full-business-simulation.integration.test.ts
 * @description 测试模块，围绕 full-business-simulation.integration.test.ts 场景验证 tests/integration 相关业务行为与边界条件。
 */
