/**
 * @module tests/services/liquidationCooldown/tradeLogHydrator.business.test.ts
 * @description 测试模块，围绕 tradeLogHydrator.business.test.ts 场景验证 tests/services/liquidationCooldown 相关业务行为与边界条件。
 */
