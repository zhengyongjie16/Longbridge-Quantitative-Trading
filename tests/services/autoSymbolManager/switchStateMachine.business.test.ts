/**
 * @module tests/services/autoSymbolManager/switchStateMachine.business.test.ts
 * @description 测试模块，围绕 switchStateMachine.business.test.ts 场景验证 tests/services/autoSymbolManager 相关业务行为与边界条件。
 */
